...
.PHONY: lighthouse-badges

update-lighthouse-badges: lighthouse-badges
	$(MAKE_DIR)/scripts/update-badges.sh
.PHONY: update-lighthouse-badges

clean-build-output:
	rm -rf ./dist
.PHONY: clean-build-output
...
.PHONY: prepare-static-files

generate-service-worker:
	deno -A $(MAKE_DIR)/scripts/generate-sw.js
.PHONY: generate-service-worker
